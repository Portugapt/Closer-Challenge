...
dfInsurance.drop(columns=['DATA_MAIN_CUT'])
...
######
## [22] Bin Premiums by Customer Monetary Value
## Application: Addition
######
...
dfInsurance['minmax_amt_plob_household'] = scaler.fit_transform(dfInsurance[['minmax_amt_plob_household']])
...
######
## [16] Standard Scale features
## Application: Addition
######

sd_scaler = StandardScaler()
dfInsurance['norm_amt_plob_motor'] = sd_scaler.fit_transform(dfInsurance[['amt_plob_motor']])
dfInsurance['norm_amt_plob_household'] = sd_scaler.fit_transform(dfInsurance[['norm_amt_plob_household']])
...
######
## [17] Scale Features with Square Root
## Application: Addition
######
